...
#define nstates2	6	/* writer */
#define minseq2	14
#define maxseq2	18
#define endstate2	5

#define nstates1	6	/* reader */
#define minseq1	9
#define maxseq1	13
#define endstate1	5
...
struct cond_var { /* user defined type */
	int x;
};
#define Pwriter	((P2 *)this)
typedef struct P2 { /* writer */
...
typedef struct State {
	...
	#endif
#endif
	struct cond_var readers_proceed;
	struct cond_var writer_proceed;
#ifdef TRIX
...
#define HAS_TRACK	0
/* hidden variable: */	uchar read_write_lock;
/* hidden variable: */	int readers;
/* hidden variable: */	int writers;
/* hidden variable: */	int pending_writers;
